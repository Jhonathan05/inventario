// ActivosFormData.js - Constantes para listas desplegables del formulario de activos

export const EMPRESAS_PROPIETARIAS = [
    'ALMACAFE',
    'FEDERACION',
    'BANCOLOMBIA',
    'CAFECERT',
...
export const FUENTES_RECURSO = ['FON1', 'FON2', 'FEPC'];

export const TIPOS_RECURSO = ['PAC', 'PROYECTO', 'RECURSO PROPIO'];

export const EMPRESAS_FUNCIONARIO = [
    'ALMACAFE',
    'FEDERACION',
    'TIVIT',
    'SAMTEL',
...
export const TIPOS_PERSONAL = ['EMPLEADO', 'CONTRATISTA'];

export const CARGOS = [
    'Analista',
    'Analista Bienes y Servicios',
    'Analista Compras',
    'Analista Financiero',
    'Analista Gestión Humana',
    'Analista Planeación Financiera y Presupuesto',
    'Analista Programa de Comunicaciones',
    'Analista Proyectos',
    'Analista TIC',
    'Aprendiz',
    'Auxiliar Administrativo',
    'Auxiliar Bienes y Servicios',
    'Auxiliar Gestión Humana',
    'Auxiliar Servicios',
    'Coordinador Administrativo',
    'Coordinador Contable',
    'Coordinador Financiero',
    'Coordinador Fortalecimiento Gremial',
    'Coordinador Grupo Beneficio Ecológico',
    'Coordinador Programa',
    'Coordinador Seccional Extensión Rural',
    'Director Ejecutivo',
    'Extensionista',
    'Líder Departamental Extensión Rural',
    'No Aplica',
    'Pasante',
    'Profesional Desarrollo Social',
    'Promotor Desarrollo Rural',
    'Recepción',
    'Sica',
    'Tesorero Auxiliar',
];
...
export const RAZONES_ESTADO = [
    'DISPONIBLE',
    'CUSTODIA',
    'ALISTAMIENTO / SOPORTE',
    'RENOVACIÓN',
    'PROCESAR BAJA',
    'DESPACHO',
    'RETORNO',
...
export const PROCESADORES = [
    ...
    '11TH GEN INTEL(R) CORE(TM) I7-11700T @ 1.40GHZ',
    ...
    'APPLE M2',
    'APPLE M3',
    'INTEL(R) ATOM(TM) X5-Z8550 CPU @ 1.44GHZ',
    ...
    'INTEL(R) CORE(TM) I3-8100T CPU @ 3.10GHZ',
    ...
    'INTEL(R) CORE(TM) I5-10400T CPU @ 2.00GHZ',
    ...
    'Exynos 9810 de ocho núcleos a 2 GHz + 1,7 GHz',
    'No Aplica',
];

export const MEMORIAS_RAM = [
    '512 MB',
    '1GB',
    '2GB',
    '4GB',
